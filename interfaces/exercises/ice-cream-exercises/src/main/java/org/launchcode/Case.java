...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Chopped nuts", 1.0, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping2 = new Topping("Crushed pineapple", 0.50, new ArrayList<>(Arrays.asList("fruit")));
        Topping topping3 = new Topping("Hot fudge", 1.5, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping4 = new Topping("Maraschino cherry", .25, new ArrayList<>(Arrays.asList("fruit", "red #5")));
